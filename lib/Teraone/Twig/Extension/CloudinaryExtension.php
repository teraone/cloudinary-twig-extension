...
class CloudinaryExtension extends \Twig_Extension
{
    ...
    {
        return array(
            'cl_upload_url'                          => new \Twig_Function_Method($this, 'cl_upload_url'),
            'cl_upload_tag_params'                   => new \Twig_Function_Method($this, 'cl_upload_tag_params'),
            'cl_unsigned_image_upload_tag'           => new \Twig_Function_Method($this, 'cl_unsigned_image_upload_tag', array('is_safe' => array('html'))),
            'cl_image_upload_tag'                    => new \Twig_Function_Method($this, 'cl_image_upload_tag', array('is_safe' => array('html'))),
            'cl_upload_tag'                          => new \Twig_Function_Method($this, 'cl_upload_tag',array('is_safe' => array('html'))),
            'cl_form_tag'                            => new \Twig_Function_Method($this, 'cl_form_tag', array('is_safe' => array('html'))),
            'cl_image_tag'                           => new \Twig_Function_Method($this, 'cl_image_tag', array('is_safe' => array('html'))),
            'fetch_image_tag'                        => new \Twig_Function_Method($this, 'fetch_image_tag', array('is_safe' => array('html'))),
            'facebook_profile_image_tag'             => new \Twig_Function_Method($this, 'facebook_profile_image_tag', array('is_safe' => array('html'))),
            'gravatar_profile_image_tag'             => new \Twig_Function_Method($this, 'gravatar_profile_image_tag', array('is_safe' => array('html'))),
            'twitter_profile_image_tag'              => new \Twig_Function_Method($this, 'twitter_profile_image_tag', array('is_safe' => array('html'))),
            'twitter_name_profile_image_tag'         => new \Twig_Function_Method($this, 'twitter_name_profile_image_tag', array('is_safe' => array('html'))),
            'cloudinary_js_config'                   => new \Twig_Function_Method($this, 'cloudinary_js_config', array('is_safe' => array('html', 'js'))),
            'cloudinary_url'                         => new \Twig_Function_Method($this, 'cloudinary_url'),
            'cl_sprite_url'                          => new \Twig_Function_Method($this, 'cl_sprite_url'),
            'cl_sprite_tag'                          => new \Twig_Function_Method($this, 'cl_sprite_tag', array('is_safe' => array('html'))),
            'cl_video_path'                          => new \Twig_Function_Method($this, 'cl_video_path'),
            'cl_video_thumbnail_tag'                 => new \Twig_Function_Method($this, 'cl_video_thumbnail_tag', array('is_safe' => array('html'))),
            'cl_video_thumbnail_path'                 => new \Twig_Function_Method($this, 'cl_video_thumbnail_path'),
            'cl_video_tag'                           => new \Twig_Function_Method($this, 'cl_video_tag', array('is_safe' => array('html'))),
